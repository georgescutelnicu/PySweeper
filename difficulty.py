...
class Difficulty(tk.Tk):
    ...
    def __init__(self):
        ...
        self.easy_radio = tk.Radiobutton(self, text="Easy", variable=self.difficulty_level, value="easy",
                                         font=("Helvetica", 12), command=self.update_difficulty)
        self.medium_radio = tk.Radiobutton(self, text="Medium", variable=self.difficulty_level, value="medium",
                                           font=("Helvetica", 12), command=self.update_difficulty)
        self.hard_radio = tk.Radiobutton(self, text="Hard", variable=self.difficulty_level, value="hard",
                                         font=("Helvetica", 12), command=self.update_difficulty)
